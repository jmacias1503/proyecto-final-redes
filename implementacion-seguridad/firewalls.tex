...
El hardware seleccionado es el \textbf{Fortinet FortiGate 40F}. Este equipo es un firewall físico de nueva generación (NGFW) diseñado para redes empresariales pequeñas y medianas, con alto rendimiento y seguridad avanzada.

La justificación de esta elección se basa en varios puntos clave:
\begin{itemize}
    \item \textbf{Rendimiento de Red:} Ofrece un throughput de firewall superior a 5 Gbps y protección contra amenazas adecuada para el tráfico de un edificio de aulas con múltiples VLAN y usuarios concurrentes.
    ...
    \item \textbf{Costo y Soporte:} El modelo FortiGate 40F se ajusta al presupuesto del proyecto (aproximadamente \$10,539 MXN) y puede complementarse con la licencia de soporte FortiCare Premium de 1 año.
\end{itemize}

\subsubsection{Plataforma de Software (NGFW)}
El FortiGate 40F opera con \textbf{FortiOS}, el sistema operativo propietario de Fortinet para firewalls de nueva generación. FortiOS proporciona una interfaz gráfica moderna para la administración del firewall, la configuración de servicios de red (DHCP, DNS), la creación de VPNs y el monitoreo detallado del tráfico y de los eventos de seguridad.
